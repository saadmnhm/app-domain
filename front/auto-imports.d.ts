...
declare global {
  ...
  const formatFormErrors: typeof import('./src/utils/errorHandler')['formatFormErrors']
  const getActivePinia: typeof import('pinia')['getActivePinia']
  const getAllErrorMessages: typeof import('./src/utils/errorHandler')['getAllErrorMessages']
  const getCurrentInstance: typeof import('vue')['getCurrentInstance']
  const getCurrentScope: typeof import('vue')['getCurrentScope']
  const getErrorNotification: typeof import('./src/utils/errorHandler')['getErrorNotification']
  const getFirstErrorMessage: typeof import('./src/utils/errorHandler')['getFirstErrorMessage']
  ...
  const parseApiError: typeof import('./src/utils/errorHandler')['parseApiError']
